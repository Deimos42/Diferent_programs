...
void __fastcall TForm1::Button1Click(TObject *Sender)
{
	...
	//Label39->Caption = w;    для проверки размеров ммножеств
	//Label40->Caption = w2;
	//Label41->Caption = w3;
	//Label42->Caption = w4;
...
void __fastcall TForm1::Button9Click(TObject *Sender)
{
	...
	if(index == -1)
	{
		AnsiString str2 = "Такого элемента не существует во множестве";
		ShowMessage(str2);
	}
	else
	{
		AnsiString str2 = "Элемент располагается под индексом: " + IntToStr(index);
		ShowMessage(str2);
	}
}
//---------------------------------------------------------------------------
